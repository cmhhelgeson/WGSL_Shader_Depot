...
fn computeMain( 
  ...
  (*dst_particle).velocity += vec2<f32>(0.0, 1.0) * particle_uniforms.gravity * general_uniforms.deltaTime;
  (*dst_particle).position += (*dst_particle).velocity * general_uniforms.deltaTime;
  if (
